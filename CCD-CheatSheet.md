...
||`event.code : 15`|15 -> File create stream hash, able to track for chrome or firefox downloads especially if downloaded via a webmail client or website (winlog.event_data.Contents show the website downloaded) and can get file hash|
