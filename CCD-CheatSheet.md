...
OR Sysmon Event ID 12 (Registry Object Created), 13 (Registry Set Value) OR 14 (Registry Object Renamed). For 13, filter it with `Task` as the keyword in event log explorer
