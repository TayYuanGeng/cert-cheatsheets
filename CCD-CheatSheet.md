...
|MSSQL Logs|`<Drive Name>\MSSQL15.MSSQLSERVER\MSSQL\Log\ERRORLOG`|Useful to check which MSSQL account has attempted to logon and the IP address initiating it|
