...
- Use Security -> Hosts then filter to certain process then press on events. There will be a square cube at each record, use it to see how a e.g. malicious executable call the processes, dll, registry keys etc. via a chained map
