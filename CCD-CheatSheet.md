...
||4672 -> Special privilege logon, can list the privileges assigned to the user, if can't find 4672 event id then check in `C:\Windows\security\logs\scesrv.log`|
